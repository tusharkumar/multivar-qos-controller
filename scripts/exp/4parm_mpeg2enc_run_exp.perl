...
$explore_space{"srt"} = [-1];
for my $hf (0,1,2,3,4,5,6,7) {
	for my $hb (0,1,2,3,4,5,6,7) {
		for my $vf (0,1,2,3,4,5,6,7) {
			for my $vb (0,1,2,3,4,5,6,7) {
				push @{$explore_space{"srt"}}, $hf*1000+$hb*100+$vf*10+$vb;
}}}}
...
if(@{$explore_space{"test"}} > 1) {
	...
	system "perl ../scripts/extract_time_sequence.pl log${suffix}";
}
